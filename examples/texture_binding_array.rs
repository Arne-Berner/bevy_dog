...
fn main() {
    ...
    app.add_plugins((
        ...
        // also a material inside this file?
        // what does bindless mean in this context? TODO
...
// they probably have to fit
const MAX_TEXTURE_COUNT: usize = 16;
const TILE_IDS: [usize; 16] = [
